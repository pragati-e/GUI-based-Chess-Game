 ...
 * File Name: King.java
 * 
 * Description: Basic principles governing King movement on a chessboard are defined 
 */
...
public class King extends Piece {
    //extra variables to keep track of the king's position
	private int x,y; 
	...
	//overridden from Pieces package
	public ArrayList<Cell> move(Cell state[][],int x,int y) {
		//The King can only take one step forward resulting in all eight adjacent cells been taken into account
		possiblemoves.clear();
	...
	//checking if the king is in danger by determining if any piece of the opposite color may attack the king for a particular board condition
	public boolean isindanger(Cell state[][]) {
		//attacking from the left, right, up, and down
    	for(int i=x+1;i<8;i++) {
		...
		//checking for attack from the Knight of opposite player
		...
		//checking for attack from the Pawn of opposite player
